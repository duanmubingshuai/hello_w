...
extern uint8_t  ll_hw_write_tfifo1(uint8_t* txPkt, uint16_t pktLen);
extern void rf_phy_bb_cfg1(uint8_t pktFmt);
...
void phy_rf_tx(void)
{
    ...
    ll_hw_write_tfifo1(phyBufTx,phyBufTx[1]+2);
    phy_hw_go();
    llWaitingIrq=TRUE;
