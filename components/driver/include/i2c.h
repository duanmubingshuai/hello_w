...
*
*******************************************************************************/
#ifndef __I2C_ROM_H__
#define __I2C_ROM_H__
...
void master_send_read_cmd(uint8_t len);
int i2c_wait_tx_completed(void);
int i2c_tx_start(void);
int i2cs_pin_init(iic_pin_e pin_mod);
void i2c_send_byte(uint8_t data);
int i2c_read(uint16_t slave_addr,uint16_t reg,uint8_t* data,uint16_t size);
int i2c_write(uint16_t slave_addr,uint16_t reg,uint8_t* data,uint16_t size);
//int eeprom_page_init(void);
int eeprom_init(iic_pin_e pin_mod, gpio_pin_e pin);
//int eeprom_page_write(uint16_t device_address,uint16_t word_address,uint8_t *data,uint16_t size);
int eeprom_page_write(uint16_t word_address,uint8_t *data,uint16_t size);
//int eeprom_random_read(uint16_t device_address,uint16_t word_address,uint8_t *data_buf,uint16_t size);
int eeprom_random_read(uint16_t word_address,uint8_t *data,uint16_t size);
