...
void gattServApp_ProcessMsg( gattMsgEvent_t *pMsg )
{
	...
	linkDBItem_t *pLinkItem = linkDB_Find( 0 );
//	pLinkItem->pEncParams->keySize = 16;
	LOG("pLinkItem->pEncParams 0x%p\n",pLinkItem->pEncParams);
	LOG("pLinkItem->pEncParams->keySize 0x%X\n",pLinkItem->pEncParams->keySize);
