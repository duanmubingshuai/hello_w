...
#define PICO_REG_OTP_COUNT 9

#define PICO_REG_OTP_BASE_ADDR 0x1FFFC000

#define PICO_REG_OTP_SIZE 0x00000020
 ...
 * </pre>
 */
#define PICO_REG_OTP_MODE_SETTING_OFFSET 0x00000000


__INLINE static uint32_t otp_mode_setting_get(void)
{
    return _PICO_REG_RD(PICO_REG_OTP_MODE_SETTING_OFFSET + PICO_REG_OTP_BASE_ADDR);
}

__INLINE static void otp_mode_setting_set(uint32_t value)
{
    _PICO_REG_WR(PICO_REG_OTP_MODE_SETTING_OFFSET+ PICO_REG_OTP_BASE_ADDR, value);
}
...
__INLINE static void otp_mode_setting_pack(uint8_t softmode, uint8_t testmode, uint8_t progreammodeen, uint8_t deepsleepmodeen, uint8_t readen, uint8_t poweron)
{
    _PICO_REG_WR(PICO_REG_OTP_MODE_SETTING_OFFSET+ PICO_REG_OTP_BASE_ADDR,  ((uint32_t)softmode << 8) | ((uint32_t)testmode << 4) | ((uint32_t)progreammodeen << 3) | ((uint32_t)deepsleepmodeen << 2) | ((uint32_t)readen << 1) | ((uint32_t)poweron << 0));
}

__INLINE static void otp_mode_setting_unpack(uint8_t* softmode, uint8_t* testmode, uint8_t* progreammodeen, uint8_t* deepsleepmodeen, uint8_t* readen, uint8_t* poweron)
{
    volatile uint32_t localVal = _PICO_REG_RD(PICO_REG_OTP_MODE_SETTING_OFFSET + PICO_REG_OTP_BASE_ADDR);
...
{
    _PICO_REG_WR(PICO_REG_OTP_MODE_SETTING_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_MODE_SETTING_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0x00000100)) | ((uint32_t)softmode << 8));
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_MODE_SETTING_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_MODE_SETTING_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0x000000F0)) | ((uint32_t)testmode << 4));
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_MODE_SETTING_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_MODE_SETTING_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0x00000008)) | ((uint32_t)progreammodeen << 3));
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_MODE_SETTING_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_MODE_SETTING_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0x00000004)) | ((uint32_t)deepsleepmodeen << 2));
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_MODE_SETTING_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_MODE_SETTING_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0x00000002)) | ((uint32_t)readen << 1));
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_MODE_SETTING_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_MODE_SETTING_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0x00000001)) | ((uint32_t)poweron << 0));
}
 ...
 * </pre>
 */
#define PICO_REG_OTP_POWER_TIMING_CONTROL_OFFSET 0x00000004


__INLINE static uint32_t otp_power_timing_control_get(void)
{
    return _PICO_REG_RD(PICO_REG_OTP_POWER_TIMING_CONTROL_OFFSET + PICO_REG_OTP_BASE_ADDR);
}

__INLINE static void otp_power_timing_control_set(uint32_t value)
{
    _PICO_REG_WR(PICO_REG_OTP_POWER_TIMING_CONTROL_OFFSET+ PICO_REG_OTP_BASE_ADDR, value);
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_POWER_TIMING_CONTROL_OFFSET+ PICO_REG_OTP_BASE_ADDR,  ((uint32_t)tvddh << 28) | ((uint32_t)tpenh << 24) | ((uint32_t)tplh << 20) | ((uint32_t)tash << 16) | ((uint32_t)tsas << 12) | ((uint32_t)tpls << 8) | ((uint32_t)tpens << 4) | ((uint32_t)tvds << 0));
}
...
{
    volatile uint32_t localVal = _PICO_REG_RD(PICO_REG_OTP_POWER_TIMING_CONTROL_OFFSET + PICO_REG_OTP_BASE_ADDR);
...
{
    _PICO_REG_WR(PICO_REG_OTP_POWER_TIMING_CONTROL_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_POWER_TIMING_CONTROL_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0xF0000000)) | ((uint32_t)tvddh << 28));
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_POWER_TIMING_CONTROL_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_POWER_TIMING_CONTROL_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0x0F000000)) | ((uint32_t)tpenh << 24));
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_POWER_TIMING_CONTROL_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_POWER_TIMING_CONTROL_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0x00F00000)) | ((uint32_t)tplh << 20));
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_POWER_TIMING_CONTROL_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_POWER_TIMING_CONTROL_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0x000F0000)) | ((uint32_t)tash << 16));
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_POWER_TIMING_CONTROL_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_POWER_TIMING_CONTROL_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0x0000F000)) | ((uint32_t)tsas << 12));
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_POWER_TIMING_CONTROL_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_POWER_TIMING_CONTROL_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0x00000F00)) | ((uint32_t)tpls << 8));
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_POWER_TIMING_CONTROL_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_POWER_TIMING_CONTROL_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0x000000F0)) | ((uint32_t)tpens << 4));
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_POWER_TIMING_CONTROL_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_POWER_TIMING_CONTROL_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0x0000000F)) | ((uint32_t)tvds << 0));
}
 ...
 * </pre>
 */
#define PICO_REG_OTP_SETTING1_OFFSET 0x00000008


__INLINE static uint32_t otp_setting1_get(void)
{
    return _PICO_REG_RD(PICO_REG_OTP_SETTING1_OFFSET + PICO_REG_OTP_BASE_ADDR);
}

__INLINE static void otp_setting1_set(uint32_t value)
{
    _PICO_REG_WR(PICO_REG_OTP_SETTING1_OFFSET+ PICO_REG_OTP_BASE_ADDR, value);
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_SETTING1_OFFSET+ PICO_REG_OTP_BASE_ADDR,  ((uint32_t)tpwi << 21) | ((uint32_t)tpw << 16) | ((uint32_t)tpps << 11) | ((uint32_t)tcps << 4) | ((uint32_t)tms << 0));
}

__INLINE static void otp_setting1_unpack(uint8_t* tpwi, uint8_t* tpw, uint8_t* tpps, uint8_t* tcps, uint8_t* tms)
{
    volatile uint32_t localVal = _PICO_REG_RD(PICO_REG_OTP_SETTING1_OFFSET + PICO_REG_OTP_BASE_ADDR);
...
{
    _PICO_REG_WR(PICO_REG_OTP_SETTING1_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_SETTING1_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0x00E00000)) | ((uint32_t)tpwi << 21));
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_SETTING1_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_SETTING1_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0x001F0000)) | ((uint32_t)tpw << 16));
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_SETTING1_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_SETTING1_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0x0000F800)) | ((uint32_t)tpps << 11));
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_SETTING1_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_SETTING1_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0x000007F0)) | ((uint32_t)tcps << 4));
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_SETTING1_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_SETTING1_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0x0000000F)) | ((uint32_t)tms << 0));
}
 ...
 * </pre>
 */
#define PICO_REG_OTP_SETTING2_OFFSET 0x0000000C


__INLINE static uint32_t otp_setting2_get(void)
{
    return _PICO_REG_RD(PICO_REG_OTP_SETTING2_OFFSET + PICO_REG_OTP_BASE_ADDR);
}

__INLINE static void otp_setting2_set(uint32_t value)
{
    _PICO_REG_WR(PICO_REG_OTP_SETTING2_OFFSET+ PICO_REG_OTP_BASE_ADDR, value);
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_SETTING2_OFFSET+ PICO_REG_OTP_BASE_ADDR,  ((uint32_t)tmh << 16) | ((uint32_t)tppr << 8) | ((uint32_t)tpph << 0));
}

__INLINE static void otp_setting2_unpack(uint8_t* tmh, uint8_t* tppr, uint8_t* tpph)
{
    volatile uint32_t localVal = _PICO_REG_RD(PICO_REG_OTP_SETTING2_OFFSET + PICO_REG_OTP_BASE_ADDR);
...
{
    _PICO_REG_WR(PICO_REG_OTP_SETTING2_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_SETTING2_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0x000F0000)) | ((uint32_t)tmh << 16));
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_SETTING2_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_SETTING2_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0x00007F00)) | ((uint32_t)tppr << 8));
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_SETTING2_OFFSET+ PICO_REG_OTP_BASE_ADDR, (_PICO_REG_RD(PICO_REG_OTP_SETTING2_OFFSET + PICO_REG_OTP_BASE_ADDR) & ~((uint32_t)0x0000001F)) | ((uint32_t)tpph << 0));
}
 ...
 * </pre>
 */
#define PICO_REG_OTP_TEST_CTRL_OFFSET 0x00000010


__INLINE static uint32_t otp_test_ctrl_get(void)
{
    return _PICO_REG_RD(PICO_REG_OTP_TEST_CTRL_OFFSET + PICO_REG_OTP_BASE_ADDR);
}

__INLINE static void otp_test_ctrl_set(uint32_t value)
{
    _PICO_REG_WR(PICO_REG_OTP_TEST_CTRL_OFFSET+ PICO_REG_OTP_BASE_ADDR, value);
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_TEST_CTRL_OFFSET+ PICO_REG_OTP_BASE_ADDR,  ((uint32_t)tcs << 0));
}

__INLINE static void otp_test_ctrl_unpack(uint8_t* tcs)
{
    volatile uint32_t localVal = _PICO_REG_RD(PICO_REG_OTP_TEST_CTRL_OFFSET + PICO_REG_OTP_BASE_ADDR);
 ...
 * </pre>
 */
#define PICO_REG_OTP_STATE_OFFSET 0x00000014


__INLINE static uint32_t otp_state_get(void)
{
    return _PICO_REG_RD(PICO_REG_OTP_STATE_OFFSET + PICO_REG_OTP_BASE_ADDR);
}
...
{
    volatile uint32_t localVal = _PICO_REG_RD(PICO_REG_OTP_STATE_OFFSET + PICO_REG_OTP_BASE_ADDR);
 ...
 * </pre>
 */
#define PICO_REG_OTP_PROG_NUM_OFFSET 0x00000018


__INLINE static uint32_t otp_prog_num_get(void)
{
    return _PICO_REG_RD(PICO_REG_OTP_PROG_NUM_OFFSET + PICO_REG_OTP_BASE_ADDR);
}

__INLINE static void otp_prog_num_set(uint32_t value)
{
    _PICO_REG_WR(PICO_REG_OTP_PROG_NUM_OFFSET+ PICO_REG_OTP_BASE_ADDR, value);
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_PROG_NUM_OFFSET+ PICO_REG_OTP_BASE_ADDR,  ((uint32_t)programnumber << 0));
}

__INLINE static void otp_prog_num_unpack(uint8_t* programnumber)
{
    volatile uint32_t localVal = _PICO_REG_RD(PICO_REG_OTP_PROG_NUM_OFFSET + PICO_REG_OTP_BASE_ADDR);
 ...
 * </pre>
 */
#define PICO_REG_OTP_PROG_ADDR_OFFSET 0x0000001C


__INLINE static uint32_t otp_prog_addr_get(void)
{
    return _PICO_REG_RD(PICO_REG_OTP_PROG_ADDR_OFFSET + PICO_REG_OTP_BASE_ADDR);
}

__INLINE static void otp_prog_addr_set(uint32_t value)
{
    _PICO_REG_WR(PICO_REG_OTP_PROG_ADDR_OFFSET+ PICO_REG_OTP_BASE_ADDR, value);
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_PROG_ADDR_OFFSET+ PICO_REG_OTP_BASE_ADDR,  ((uint32_t)programaddress << 0));
}

__INLINE static void otp_prog_addr_unpack(uint8_t* programaddress)
{
    volatile uint32_t localVal = _PICO_REG_RD(PICO_REG_OTP_PROG_ADDR_OFFSET + PICO_REG_OTP_BASE_ADDR);
 ...
 * </pre>
 */
#define PICO_REG_OTP_PROG_DATA_OFFSET 0x00000020


__INLINE static uint32_t otp_prog_data_get(void)
{
    return _PICO_REG_RD(PICO_REG_OTP_PROG_DATA_OFFSET + PICO_REG_OTP_BASE_ADDR);
}

__INLINE static void otp_prog_data_set(uint32_t value)
{
    _PICO_REG_WR(PICO_REG_OTP_PROG_DATA_OFFSET+ PICO_REG_OTP_BASE_ADDR, value);
}
...
{
    _PICO_REG_WR(PICO_REG_OTP_PROG_DATA_OFFSET+ PICO_REG_OTP_BASE_ADDR,  ((uint32_t)programdatain << 0));
}

__INLINE static void otp_prog_data_unpack(uint8_t* programdatain)
{
    volatile uint32_t localVal = _PICO_REG_RD(PICO_REG_OTP_PROG_DATA_OFFSET + PICO_REG_OTP_BASE_ADDR);
...
#define xPICO_REG_OTP_STRUCT

#ifdef PICO_REG_OTP_STRUCT
